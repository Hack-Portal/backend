...
func NewRoomUsercase(store repository.Store, timeout time.Duration) domain.RoomUsecase {
	return &roomUsecase{
		store:          store,
...
func stackTagAndFrameworks(ctx context.Context, store repository.Store, room repository.Room) ([]domain.RoomTechTags, []domain.RoomFramework, error) {
	var (
...
func margeRoomAccount(ctx context.Context, store repository.Store, id uuid.UUID) (result []domain.NowRoomAccounts, err error) {
