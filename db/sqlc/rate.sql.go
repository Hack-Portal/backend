...
const cerateRate = `-- name: CerateRate :one
INSERT INTO rate_entries (user_id, rate)
VALUES($1, $2)
RETURNING user_id, rate, create_at
`

type CerateRateParams struct {
	UserID string `json:"user_id"`
	Rate   int32  `json:"rate"`
}

func (q *Queries) CerateRate(ctx context.Context, arg CerateRateParams) (RateEntries, error) {
	row := q.db.QueryRowContext(ctx, cerateRate, arg.UserID, arg.Rate)
	var i RateEntries
