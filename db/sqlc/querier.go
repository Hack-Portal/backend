...
type Querier interface {
	...
	GetPastWorkTagsByOpus(ctx context.Context, opus int32) ([]PastWorkTags, error)
	...
	ListAccountPastWorks(ctx context.Context) ([]AccountPastWorks, error)
	...
	ListPastWorkFrameworks(ctx context.Context) ([]PastWorkFrameworks, error)
	ListPastWorkTags(ctx context.Context) ([]PastWorkTags, error)
