...
ALTER TABLE "rooms_tech_tags" DROP CONSTRAINT "rooms_tech_tags_room_id_fkey";
ALTER TABLE "rooms_tech_tags" DROP CONSTRAINT "rooms_tech_tags_tech_tag_id_fkey";
...
ALTER TABLE "rooms_frameworks" DROP CONSTRAINT "rooms_frameworks_framework_id_fkey";
ALTER TABLE "rooms_frameworks" DROP CONSTRAINT "rooms_frameworks_room_id_fkey";
...
DROP TABLE IF EXISTS "rooms_frameworks";
