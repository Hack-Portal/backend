...
type AccountUsecase interface {
	...
	CreateAccount(ctx context.Context, body params.CreateAccount, image []byte, email string) (response.AccountResponse, error)
	UpdateAccount(ctx context.Context, body params.UpdateAccountParams, image []byte) (response.AccountResponse, error)
