...
func (q *Queries) CreateLikes(ctx context.Context, arg CreateLikesParams) (Like, error) {
	row := q.db.QueryRow(ctx, createLikes, arg.Opus, arg.AccountID)
	var i Like
	err := row.Scan(
		&i.Opus,
		&i.AccountID,
...
func (q *Queries) DeleteLikesByID(ctx context.Context, arg DeleteLikesByIDParams) error {
	_, err := q.db.Exec(ctx, deleteLikesByID, arg.Opus, arg.AccountID)
	return err
}
...
func (q *Queries) GetLikeStatusByID(ctx context.Context, arg GetLikeStatusByIDParams) (Like, error) {
	row := q.db.QueryRow(ctx, getLikeStatusByID, arg.Opus, arg.AccountID)
	var i Like
	err := row.Scan(
		&i.Opus,
		&i.AccountID,
...
func (q *Queries) GetListCountByOpus(ctx context.Context, opus int32) (int64, error) {
	row := q.db.QueryRow(ctx, getListCountByOpus, opus)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) ListLikesByID(ctx context.Context, accountID string) ([]Like, error) {
	rows, err := q.db.Query(ctx, listLikesByID, accountID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
