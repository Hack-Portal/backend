...
func (q *Queries) CreateFrameworks(ctx context.Context, arg CreateFrameworksParams) (Framework, error) {
	row := q.db.QueryRow(ctx, createFrameworks, arg.Framework, arg.TechTagID)
	var i Framework
	err := row.Scan(
		&i.FrameworkID,
		&i.TechTagID,
...
func (q *Queries) DeleteFrameworksByID(ctx context.Context, frameworkID int32) error {
	_, err := q.db.Exec(ctx, deleteFrameworksByID, frameworkID)
	return err
}
...
func (q *Queries) GetFrameworksByID(ctx context.Context, frameworkID int32) (Framework, error) {
	row := q.db.QueryRow(ctx, getFrameworksByID, frameworkID)
	var i Framework
	err := row.Scan(
		&i.FrameworkID,
		&i.TechTagID,
...
func (q *Queries) UpdateFrameworksByID(ctx context.Context, arg UpdateFrameworksByIDParams) (Framework, error) {
	row := q.db.QueryRow(ctx, updateFrameworksByID, arg.Framework, arg.TechTagID, arg.FrameworkID)
	var i Framework
	err := row.Scan(
		&i.FrameworkID,
		&i.TechTagID,
