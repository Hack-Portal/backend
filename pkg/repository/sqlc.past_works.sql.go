...
func (q *Queries) CreatePastWorks(ctx context.Context, arg CreatePastWorksParams) (PastWork, error) {
	row := q.db.QueryRow(ctx, createPastWorks,
		arg.Name,
		arg.ThumbnailImage,
		arg.ExplanatoryText,
		arg.AwardDataID,
...
func (q *Queries) DeletePastWorksByID(ctx context.Context, arg DeletePastWorksByIDParams) (PastWork, error) {
	row := q.db.QueryRow(ctx, deletePastWorksByID, arg.IsDelete, arg.Opus)
	var i PastWork
	err := row.Scan(
		&i.Opus,
		&i.Name,
...
func (q *Queries) GetPastWorksByOpus(ctx context.Context, opus int32) (PastWork, error) {
	row := q.db.QueryRow(ctx, getPastWorksByOpus, opus)
	var i PastWork
	err := row.Scan(
		&i.Opus,
		&i.Name,
...
func (q *Queries) ListPastWorks(ctx context.Context, arg ListPastWorksParams) ([]ListPastWorksRow, error) {
	rows, err := q.db.Query(ctx, listPastWorks, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdatePastWorksByID(ctx context.Context, arg UpdatePastWorksByIDParams) (PastWork, error) {
	row := q.db.QueryRow(ctx, updatePastWorksByID,
		arg.Name,
		arg.ThumbnailImage,
		arg.ExplanatoryText,
		arg.AwardDataID,
