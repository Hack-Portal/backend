...
func (m *MockStore) GetAccountsByEmail(ctx context.Context, email string) (repository.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateTechTagsByID(ctx context.Context, arg repository.UpdateTechTagsByIDParams) (repository.TechTag, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateTechTagsByID", ctx, arg)
	ret0, _ := ret[0].(repository.TechTag)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) UpdateTechTagsByID(ctx, arg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateTechTagsByID", reflect.TypeOf((*MockStore)(nil).UpdateTechTagsByID), ctx, arg)
}
